...
export function ChangePassword({ totpEnabled }: { totpEnabled: boolean }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="animate-fade-in-up p-4 bg-bg-elevated/50 border border-border-default rounded-lg">
